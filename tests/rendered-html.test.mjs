...
test("preserves all four visual systems and motion safeguards", async () => {
  ...
  assert.match(css, /Unbounded Variable/);
  assert.match(css, /Bricolage Grotesque Variable/);
  assert.match(css, /data-vibe=system/);
  assert.match(css, /data-vibe=geometry/);
  assert.match(css, /data-vibe=playground/);
  assert.match(css, /system-scan/);
  assert.match(css, /geometry-spin/);
  assert.match(css, /playground-float/);
